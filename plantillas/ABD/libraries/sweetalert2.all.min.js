...
!(function (t, e) {
    ...
    var g = {},
        ...
        et = function (t, e, n) {
            if (
                ...
                if ("string" != typeof e.customClass[n] && !e.customClass[n].forEach)
                    return void E(
                        "Invalid type of customClass.".concat(n, '! Expected string or iterable object, got "').concat(r(e.customClass[n]), '"')
                    );
        ...
        nt = function (t, e) {
            ...
            switch (e) {
                ...
                case "radio":
                    return (
                        t.querySelector(".".concat(w.popup, " > .").concat(w.radio, " input:checked")) ||
                        t.querySelector(".".concat(w.popup, " > .").concat(w.radio, " input:first-child"))
                    );
                case "range":
        ...
        Ct = function (t) {
            var e,
                n =
                    !!(e = j()) &&
                    (e.remove(), at([document.documentElement, document.body], [w["no-backdrop"], w["toast-shown"], w["has-column"]]), !0);
                ...
                (function (t, e, n) {
                    ...
                    Tt(o, "confirm", n),
                        ...
                        (function (t, e, n, o) {
                            ...
                            rt([t, e, n], w.styled),
                                o.confirmButtonColor && ((t.style.backgroundColor = o.confirmButtonColor), rt(t, w["default-outline"]));
    ...
    var St = { innerParams: new WeakMap(), domCache: new WeakMap() },
        ...
        qt = function (t, e) {
            ["string", "number"].includes(r(e))
                ? (t.value = "".concat(e))
                : L(e) || E('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(r(e), '"'));
        },
        Vt = {};
    (Vt.text =
        Vt.email =
                        ...
                        new MutationObserver(function () {
                            if (document.body.contains(t)) {
                                var o,
                                    i =
                                        t.offsetWidth +
                                        ((o = t), parseInt(window.getComputedStyle(o).marginLeft) + parseInt(window.getComputedStyle(o).marginRight));
    ...
    var _t = function (t, e) {
        ...
        Wt = function (t, e) {
            ...
            (t.className = "".concat(w.popup, " ").concat(mt(t) ? n.popup : "")),
                e.toast ? (rt([document.documentElement, document.body], w["toast-shown"]), rt(t, w.toast)) : rt(t, w.modal),
                et(t, e, "popup"),
                    ...
                    if (o) {
                        ...
                        if (e.icon || e.iconHtml) {
                            if (e.icon && -1 === Object.keys(C).indexOf(e.icon))
                                return (
                                    P('Unknown icon! Expected "success", "error", "warning", "info" or "question", got "'.concat(e.icon, '"')),
                                    void lt(o)
                                );
        ...
        le = function (t) {
            ...
            return (
                ...
                !de(t) &&
                !fe(t) &&
                (e === n || (!ht(n) && e instanceof HTMLElement && "INPUT" !== e.tagName && "TEXTAREA" !== e.tagName && (!ht(o) || !o.contains(e))))
            );
        },
        de = function (t) {
    ...
    var ye = function (t) {
        ...
        Pe = function (t, e) {
            ...
            n &&
                ...
                (!e && mt(F()) && (e = F()),
                st(n),
                e && (lt(e), o.setAttribute("data-button-to-replace", e.className), n.insertBefore(o, e)),
                rt([t, n], w.loading));
        },
        Be = function (t) {
    ...
    function ln() {
        ...
        e
            ? (t.popup && g.swalCloseEventFinishedCallback && (g.swalCloseEventFinishedCallback(), delete g.swalCloseEventFinishedCallback),
                    ...
                    "object" !== r(t[0]) || Cn(t[0])
                        ? ["title", "html", "icon"].forEach(function (n, o) {
                              ...
                              "string" == typeof i || Cn(i)
                                  ? (e[n] = i)
                                  : void 0 !== i && P("Unexpected type of ".concat(n, '! Expected "string" or "Element", got ').concat(r(i)));
                          })
                        : Object.assign(e, t[0]),
                    e
                );
        ...
        !(function (t) {
            ...
            (function (t) {
                (!t.target ||
                    ...
                    (E('Target parameter is not valid, defaulting to "body"'), (t.target = "body"));
            })(t),
    ...
    var Yn = new WeakMap(),
                            ...
                            if (
                                ((function (t) {
                                    for (var e in (!1 === t.backdrop &&
                                        t.allowOutsideClick &&
                                        E('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'),
                                    t))
        ...
        to = function (t, e) {
            return e.focusDeny && mt(t.denyButton)
                ...
                : !(!e.focusConfirm || !mt(t.confirmButton)) && (t.confirmButton.focus(), !0);
        },
        eo = function () {
